...
importScripts("./parser.fc2ff274.js");
var $45be0a08a4734072$exports = {};

var $9NBHU = parcelRequire("9NBHU");
var $358118d05c80eee0$exports = {};

var $2iPMe = parcelRequire("2iPMe");
var $358118d05c80eee0$require$Buffer = $2iPMe.Buffer;
!function(n, t) {
    $358118d05c80eee0$exports = t();
}("undefined" != typeof self ? self : $358118d05c80eee0$exports, function() {
    return function(n1) {
        var t1 = {};
        function r(e) {
        ...
        function(n2, t2, r1) {
                    ...
                    r3 = {
                        ...
                        buf: function(n5) {
                            var _$t = i1(function(n, t, r, e) {
                                return n.concat(r === e.length - 1 ? $358118d05c80eee0$require$Buffer.from([
                                    t,
                                    0
                                ]).readUInt16BE(0) : e.readUInt16BE(r));
                            }, [], n5);
                            return $358118d05c80eee0$require$Buffer.from(a1(function(n) {
                                return (n << 1 & 65535) >> 8;
                            }, _$t));
                        }(r3.buf)
                    };
            ...
            function c1() {
                return "undefined" != typeof $358118d05c80eee0$require$Buffer;
            }
            function s1() {
            ...
            function w(n) {
                return c1() && $358118d05c80eee0$require$Buffer.isBuffer(n);
            }
            function b(n, t) {
                return {
                    status: !0,
            ...
            e1.all = on, e1.alt = T, e1.any = un, e1.cr = dn, e1.createLanguage = function(n) {
                ...
                buffer: function buffer(n20) {
                    return h("buffer", n20).map(function(n) {
                        return $358118d05c80eee0$require$Buffer.from(n);
                    });
                },
...
$bKYYH.runWorker(function(param1) {
    ...
    var __ = function() {
        ...
        return (_P = $358118d05c80eee0$exports).alt.apply(_P, $9NBHU.toConsumableArray(seps.map(function(sep) {
            return $358118d05c80eee0$exports.string(sep);
        }))).trim($358118d05c80eee0$exports.regexp(/[^\S\n]*/));
    };
    var inner = function(arg) {
        return arg[1];
    };
    var label1 = 0;
    var parser = $358118d05c80eee0$exports.createLanguage({
        separator: function() {
            return $358118d05c80eee0$exports.regexp(/([^\S\n]*[;\n])+[^\S\n]*/);
        },
        variable: function() {
            return $358118d05c80eee0$exports.regexp(/[a-z_]+/);
        },
        program: function(r) {
            return r.block.trim($358118d05c80eee0$exports.optWhitespace);
        },
        block: function(r) {
            return $358118d05c80eee0$exports.alt(r.statementSequence, $358118d05c80eee0$exports.seq(__('('), r.statementSequence, __(')')).map(inner));
        },
        statement: function(r) {
            return $358118d05c80eee0$exports.alt(r.statementSkip, r.statementAssign, r.statementIf, r.statementWhile);
        },
        statementSkip: function() {
            return $358118d05c80eee0$exports.seq($358118d05c80eee0$exports.string('skip'), $358118d05c80eee0$exports.index).map(function(param) {
                var _param = $9NBHU.slicedToArray(param, 2), type = _param[0], position = _param[1];
                return $9NBHU.objectSpread({
                    type: type,
                    label: label1
                }, position);
            });
        ...
        statementAssign: function(r) {
            return $358118d05c80eee0$exports.seq(r.variable, __(':='), r.numeric, $358118d05c80eee0$exports.index).map(function(param) {
                var _param = $9NBHU.slicedToArray(param, 4), variable = _param[0], _ = _param[1], expression = _param[2], position = _param[3];
                return $9NBHU.objectSpread({
                    type: 'assign',
                    label: label1,
                    variable: variable,
        ...
        statementIf: function(r) {
            return $358118d05c80eee0$exports.seq(__('if'), r.boolean, $358118d05c80eee0$exports.index, __('then'), r.block, __('else'), r.block).map(function(param) {
                var _param = $9NBHU.slicedToArray(param, 7), _if = _param[0], condition = _param[1], position = _param[2], _then = _param[3], ifBody = _param[4], _else = _param[5], elseBody = _param[6];
                return $9NBHU.objectSpread({
                    type: 'if',
                    label: label1,
                    condition: condition,
        ...
        statementWhile: function(r) {
            return $358118d05c80eee0$exports.seq(__('while'), r.boolean, $358118d05c80eee0$exports.index, __('do'), r.block).map(function(param) {
                var _param = $9NBHU.slicedToArray(param, 5), _while = _param[0], condition = _param[1], position = _param[2], _do = _param[3], body = _param[4];
                return $9NBHU.objectSpread({
                    type: 'while',
                    label: label1,
                    condition: condition,
        ...
        statementSequence: function(r) {
            return $358118d05c80eee0$exports.sepBy1(r.statement, r.separator.atLeast(1)).trim(r.separator.many()).map(function(statements) {
                return {
                    type: 'seq',
        ...
        numericLevel1: function(r) {
            return $358118d05c80eee0$exports.seq(r.numericLevel2, $358118d05c80eee0$exports.seq(__('+', '-'), r.numericLevel2).many()).map(function(param2) {
                var _param1 = $9NBHU.slicedToArray(param2, 2), init = _param1[0], expr = _param1[1];
                return expr.reduce(function(left, param) {
                    var _param = $9NBHU.slicedToArray(param, 2), type = _param[0], right = _param[1];
                    return {
                        type: type,
                        left: left,
                        right: right
        ...
        numericLevel2: function(r) {
            return $358118d05c80eee0$exports.seq(r.numericLevel3, $358118d05c80eee0$exports.seq(__('*', '/'), r.numericLevel3).many()).map(function(param3) {
                var _param2 = $9NBHU.slicedToArray(param3, 2), init = _param2[0], expr = _param2[1];
                return expr.reduce(function(left, param) {
                    var _param = $9NBHU.slicedToArray(param, 2), type = _param[0], right = _param[1];
                    return {
                        type: type,
        ...
        numericLevel3: function(r) {
            return $358118d05c80eee0$exports.alt(r.numericConstant, r.numericVariable, r.numericGroup);
        },
        numericConstant: function() {
            return $358118d05c80eee0$exports.regex(/-?[0-9]+/).map(Number).map(function(value) {
                return {
                    type: 'n',
                    value: value
                };
        ...
        numericGroup: function(r) {
            return $358118d05c80eee0$exports.seq(__('('), r.numeric, __(')')).map(inner);
        },
        boolean: function(r) {
            return r.booleanLevel1;
        },
        booleanLevel1: function(r) {
            return $358118d05c80eee0$exports.seq(r.booleanLevel2, $358118d05c80eee0$exports.seq(__('or'), r.booleanLevel2).many()).map(function(param4) {
                var _param3 = $9NBHU.slicedToArray(param4, 2), init = _param3[0], expr = _param3[1];
                return expr.reduce(function(left, param) {
                    var _param = $9NBHU.slicedToArray(param, 2), type = _param[0], right = _param[1];
                    return {
                        type: type,
        ...
        booleanLevel2: function(r) {
            return $358118d05c80eee0$exports.seq(r.booleanLevel3, $358118d05c80eee0$exports.seq(__('and'), r.booleanLevel3).many()).map(function(param5) {
                var _param4 = $9NBHU.slicedToArray(param5, 2), init = _param4[0], expr = _param4[1];
                return expr.reduce(function(left, param) {
                    var _param = $9NBHU.slicedToArray(param, 2), type = _param[0], right = _param[1];
                    return {
                        type: type,
        ...
        booleanLevel3: function(r) {
            return $358118d05c80eee0$exports.alt(r.booleanConstant, r.booleanComparison, r.booleanGroup, r.booleanNegation);
        },
        booleanConstant: function() {
            return $358118d05c80eee0$exports.alt($358118d05c80eee0$exports.string('true'), $358118d05c80eee0$exports.string('false')).map(function(type) {
                return {
                    type: type
                };
            });
        ...
        booleanComparison: function(r) {
            return $358118d05c80eee0$exports.seq(r.numeric, __('<', '>', '<=', '>=', '==', '!='), r.numeric).map(function(param) {
                var _param = $9NBHU.slicedToArray(param, 3), left = _param[0], type = _param[1], right = _param[2];
                return {
                    type: type,
                    left: left,
                    right: right
        ...
        booleanGroup: function(r) {
            return $358118d05c80eee0$exports.seq(__('('), r.boolean, __(')')).map(inner);
        },
        booleanNegation: function(r) {
            return $358118d05c80eee0$exports.seq(__('not'), r.boolean).map(function(param) {
                var _param = $9NBHU.slicedToArray(param, 2), type = _param[0], value = _param[1];
                return {
                    type: type,
                    value: value
                };
    ...
    if (parserResult.status) {
        ...
        var relabelStatement = function(statement) {
            if (statement.type === 'seq') return $9NBHU.objectSpread({}, statement, {
            ...
            switch(statement.type){
                case 'skip':
                    return $9NBHU.objectSpread({}, statement, {
                        label: label
                    });
                case 'assign':
        ...
        return {
            ...
            variables: $9NBHU.toConsumableArray(variables)
        };
    } else return $9NBHU.objectSpread({
        succeeded: false,
...
//# sourceMappingURL=parser.9bddf82d.js.map
