...
})({"iZ8tU":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "setupMode", function() {
    return setupMode;
});
...
var TextEditChangeImpl = function() {
    ...
    TextEditChangeImpl2.prototype.insert = function(position, newText, annotation) {
        var edit2;
        var id;
        if (annotation === void 0) edit2 = TextEdit.insert(position, newText);
    ...
    TextEditChangeImpl2.prototype.replace = function(range, newText, annotation) {
        var edit2;
        var id;
        if (annotation === void 0) edit2 = TextEdit.replace(range, newText);
        else if (ChangeAnnotationIdentifier.is(annotation)) {
            id = annotation;
    ...
    TextEditChangeImpl2.prototype.delete = function(range, annotation) {
        var edit2;
        var id;
        if (annotation === void 0) edit2 = TextEdit.del(range);
        else if (ChangeAnnotationIdentifier.is(annotation)) {
            id = annotation;
...
var DiagnosticsAdapter = /*#__PURE__*/ function() {
    ...
    function _class(_languageId, _worker, configChangeEvent) {
        ...
        var onModelRemoved = function(model) {
            monaco_editor_core_exports.editor.setModelMarkers(model, _this2._languageId, []);
...
function createTokenizationSupport(supportComments) {
    return {
        ...
        tokenize: function(line, state) {
            return tokenize(supportComments, line, state);
        }
    };
}
...
var ParentsStack = /*#__PURE__*/ function() {
    ...
    _helpers.createClass(_class, null, [
        {
            key: "pop",
...
function tokenize(comments, line, state) {
    ...
    var scanner2 = createScanner2(line);
...
var JSONDiagnosticsAdapter = /*#__PURE__*/ function(DiagnosticsAdapter1) {
    "use strict";
    _helpers.inherits(_class, DiagnosticsAdapter1);
    ...
    function _class(languageId, worker, defaults) {
        ...
        _this._disposables.push(monaco_editor_core_exports.editor.onWillDisposeModel(function(model) {
...
},{"@swc/helpers":"erO4s","../../editor/editor.api.js":"8ZK4U","@parcel/transformer-js/src/esmodule-helpers.js":"5oERU"}]},[], null, "parcelRequire3aa6")

//# sourceMappingURL=jsonMode.b17f0993.js.map
