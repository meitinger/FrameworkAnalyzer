...
})({"bcSFQ":[function(require,module,exports) {
...
function from(value, encodingOrOffset, length) {
    ...
    if (value == null) throw new TypeError("The first argument must be one of type string, Buffer, ArrayBuffer, Array, or Array-like Object. Received type " + (typeof value === "undefined" ? "undefined" : _helpers.typeOf(value)));
    ...
    throw new TypeError("The first argument must be one of type string, Buffer, ArrayBuffer, Array, or Array-like Object. Received type " + (typeof value === "undefined" ? "undefined" : _helpers.typeOf(value)));
}
/**
...
function byteLength(string, encoding) {
    ...
    if (typeof string !== 'string') throw new TypeError('The "string" argument must be one of type string, Buffer, or ArrayBuffer. Received type ' + (typeof string === "undefined" ? "undefined" : _helpers.typeOf(string)));
...
Buffer.prototype.compare = function compare(target, start, end, thisStart, thisEnd) {
    ...
    if (!Buffer.isBuffer(target)) throw new TypeError('The "target" argument must be one of type Buffer or Uint8Array. Received type ' + (typeof target === "undefined" ? "undefined" : _helpers.typeOf(target)));
...
var errors = {};
function E(sym, getMessage, Base1) {
    errors[sym] = /*#__PURE__*/ function(Base) {
        _helpers.inherits(NodeError, Base);
        var _super = _helpers.createSuper(NodeError);
        function NodeError() {
            _helpers.classCallCheck(this, NodeError);
            var _this;
            _this = _super.call(this);
            Object.defineProperty(_helpers.assertThisInitialized(_this), 'message', {
                value: getMessage.apply(_helpers.assertThisInitialized(_this), arguments),
                writable: true,
                configurable: true
            });
        ...
        _helpers.createClass(NodeError, [
            {
                key: "code",
                get: function get() {
                    return sym;
...
E('ERR_INVALID_ARG_TYPE', function(name, actual) {
    return 'The "'.concat(name, '" argument must be of type number. Received type ').concat(typeof actual === "undefined" ? "undefined" : _helpers.typeOf(actual));
}, TypeError);
E('ERR_OUT_OF_RANGE', function(str, range, input) {
    var msg = 'The value of "'.concat(str, '" is out of range.');
    var received = input;
    if (Number.isInteger(input) && Math.abs(input) > Math.pow(2, 32)) received = addNumericalSeparator(String(input));
    else if ((typeof input === "undefined" ? "undefined" : _helpers.typeOf(input)) === 'bigint') {
...
function checkIntBI(value, min, max, buf, offset, byteLength10) {
    if (value > max || value < min) {
        var n = (typeof min === "undefined" ? "undefined" : _helpers.typeOf(min)) === 'bigint' ? 'n' : '';
        var range;
        if (byteLength10 > 3) {
            if (min === 0 || min === BigInt(0)) range = ">= 0".concat(n, " and < 2").concat(n, " ** ").concat((byteLength10 + 1) * 8).concat(n);
            else range = ">= -(2".concat(n, " ** ").concat((byteLength10 + 1) * 8 - 1).concat(n, ") and < 2 ** ") + "".concat((byteLength10 + 1) * 8 - 1).concat(n);
...
},{"@swc/helpers":"a3Ul6","base64-js":"jvyBn","ieee754":"b6F0U"}],"a3Ul6":[function(require,module,exports) {
...
},{"./_construct":"6L5WN","./_is_native_function":"laS3m","./_get_prototype_of":"hJSV9","./_set_prototype_of":"chJ7M","@parcel/transformer-js/src/esmodule-helpers.js":"60l5z"}],"jvyBn":[function(require,module,exports) {
'use strict';
...
},{}],"b6F0U":[function(require,module,exports) {
...
//# sourceMappingURL=parser.92194fc9.js.map
