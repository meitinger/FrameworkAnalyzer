importScripts("./parser.92194fc9.js");
...
})({"8NQFD":[function(require,module,exports) {
...
_helpers1.runWorker(function(param1) {
    ...
    var __ = function() {
        ...
        return (_P = _parsimmon).alt.apply(_P, _helpers.toConsumableArray(seps.map(function(sep) {
            return _parsimmon.string(sep);
        }))).trim(_parsimmon.regexp(/[^\S\n]*/));
    };
    var inner = function(arg) {
        return arg[1];
    };
    var label1 = 0;
    var parser = _parsimmon.createLanguage({
        separator: function() {
            return _parsimmon.regexp(/([^\S\n]*[;\n])+[^\S\n]*/);
        },
        variable: function() {
            return _parsimmon.regexp(/[a-z_]+/);
        },
        program: function(r) {
            return r.block.trim(_parsimmon.optWhitespace);
        },
        block: function(r) {
            return _parsimmon.alt(r.statementSequence, _parsimmon.seq(__('('), r.statementSequence, __(')')).map(inner));
        },
        statement: function(r) {
            return _parsimmon.alt(r.statementSkip, r.statementAssign, r.statementIf, r.statementWhile);
        },
        statementSkip: function() {
            return _parsimmon.seq(_parsimmon.string('skip'), _parsimmon.index).map(function(param) {
                var _param = _helpers.slicedToArray(param, 2), type = _param[0], position = _param[1];
        ...
        statementAssign: function(r) {
            return _parsimmon.seq(r.variable, __(':='), r.numeric, _parsimmon.index).map(function(param) {
                var _param = _helpers.slicedToArray(param, 4), variable = _param[0], _ = _param[1], expression = _param[2], position = _param[3];
                return _helpers.objectSpread({
                    type: 'assign',
                    label: label1,
                    variable: variable,
        ...
        statementIf: function(r) {
            return _parsimmon.seq(__('if'), r.boolean, _parsimmon.index, __('then'), r.block, __('else'), r.block).map(function(param) {
                var _param = _helpers.slicedToArray(param, 7), _if = _param[0], condition = _param[1], position = _param[2], _then = _param[3], ifBody = _param[4], _else = _param[5], elseBody = _param[6];
                return _helpers.objectSpread({
                    type: 'if',
                    label: label1,
                    condition: condition,
        ...
        statementWhile: function(r) {
            return _parsimmon.seq(__('while'), r.boolean, _parsimmon.index, __('do'), r.block).map(function(param) {
                var _param = _helpers.slicedToArray(param, 5), _while = _param[0], condition = _param[1], position = _param[2], _do = _param[3], body = _param[4];
                return _helpers.objectSpread({
                    type: 'while',
                    label: label1,
                    condition: condition,
        ...
        statementSequence: function(r) {
            return _parsimmon.sepBy1(r.statement, r.separator.atLeast(1)).trim(r.separator.many()).map(function(statements) {
                return {
                    type: 'seq',
        ...
        numericLevel1: function(r) {
            return _parsimmon.seq(r.numericLevel2, _parsimmon.seq(__('+', '-'), r.numericLevel2).many()).map(function(param2) {
                var _param1 = _helpers.slicedToArray(param2, 2), init = _param1[0], expr = _param1[1];
                return expr.reduce(function(left, param) {
                    var _param = _helpers.slicedToArray(param, 2), type = _param[0], right = _param[1];
                    return {
                        type: type,
                        left: left,
                        right: right
        ...
        numericLevel2: function(r) {
            return _parsimmon.seq(r.numericLevel3, _parsimmon.seq(__('*', '/'), r.numericLevel3).many()).map(function(param3) {
                var _param2 = _helpers.slicedToArray(param3, 2), init = _param2[0], expr = _param2[1];
                return expr.reduce(function(left, param) {
                    var _param = _helpers.slicedToArray(param, 2), type = _param[0], right = _param[1];
                    return {
                        type: type,
        ...
        numericLevel3: function(r) {
            return _parsimmon.alt(r.numericConstant, r.numericVariable, r.numericGroup);
        },
        numericConstant: function() {
            return _parsimmon.regex(/-?[0-9]+/).map(Number).map(function(value) {
                return {
                    type: 'n',
                    value: value
                };
        ...
        numericGroup: function(r) {
            return _parsimmon.seq(__('('), r.numeric, __(')')).map(inner);
        },
        boolean: function(r) {
            return r.booleanLevel1;
        },
        booleanLevel1: function(r) {
            return _parsimmon.seq(r.booleanLevel2, _parsimmon.seq(__('or'), r.booleanLevel2).many()).map(function(param4) {
                var _param3 = _helpers.slicedToArray(param4, 2), init = _param3[0], expr = _param3[1];
                return expr.reduce(function(left, param) {
                    var _param = _helpers.slicedToArray(param, 2), type = _param[0], right = _param[1];
                    return {
                        type: type,
        ...
        booleanLevel2: function(r) {
            return _parsimmon.seq(r.booleanLevel3, _parsimmon.seq(__('and'), r.booleanLevel3).many()).map(function(param5) {
                var _param4 = _helpers.slicedToArray(param5, 2), init = _param4[0], expr = _param4[1];
                return expr.reduce(function(left, param) {
                    var _param = _helpers.slicedToArray(param, 2), type = _param[0], right = _param[1];
                    return {
                        type: type,
        ...
        booleanLevel3: function(r) {
            return _parsimmon.alt(r.booleanConstant, r.booleanComparison, r.booleanGroup, r.booleanNegation);
        },
        booleanConstant: function() {
            return _parsimmon.alt(_parsimmon.string('true'), _parsimmon.string('false')).map(function(type) {
                return {
                    type: type
                };
            });
        ...
        booleanComparison: function(r) {
            return _parsimmon.seq(r.numeric, __('<', '>', '<=', '>=', '==', '!='), r.numeric).map(function(param) {
                var _param = _helpers.slicedToArray(param, 3), left = _param[0], type = _param[1], right = _param[2];
                return {
                    type: type,
                    left: left,
                    right: right
        ...
        booleanGroup: function(r) {
            return _parsimmon.seq(__('('), r.boolean, __(')')).map(inner);
        },
        booleanNegation: function(r) {
            return _parsimmon.seq(__('not'), r.boolean).map(function(param) {
                var _param = _helpers.slicedToArray(param, 2), type = _param[0], value = _param[1];
                return {
                    type: type,
                    value: value
                };
    ...
    if (parserResult.status) {
        ...
        var relabelStatement = function(statement) {
            if (statement.type === 'seq') return _helpers.objectSpread({}, statement, {
            ...
            switch(statement.type){
                case 'skip':
                    return _helpers.objectSpread({}, statement, {
                        label: label
                    });
                case 'assign':
        ...
        return {
            ...
            variables: _helpers.toConsumableArray(variables)
        };
    } else return _helpers.objectSpread({
        succeeded: false,
        expected: parserResult.expected
    }, parserResult.index);
});

},{"@swc/helpers":"a3Ul6","parsimmon":"5aD4t","./helpers":"4IhXk"}],"5aD4t":[function(require,module,exports) {
                    ...
                    r3 = {
                        ...
                        buf: function(n5) {
                            var _$t = i1(function(n, t, r, e) {
                                return n.concat(r === e.length - 1 ? Buffer.from([
                                    t,
                                    0
                                ]).readUInt16BE(0) : e.readUInt16BE(r));
                            }, [], n5);
                            return Buffer.from(a1(function(n) {
                                return (n << 1 & 65535) >> 8;
                            }, _$t));
                        }(r3.buf)
                    };
...
},{"buffer":"bcSFQ"}]},["8NQFD"], "8NQFD", "parcelRequire3aa6")

//# sourceMappingURL=parser.1d166427.js.map
