...
})({"eMeK1":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getJavaScriptWorker", function() {
    return getJavaScriptWorker2;
});
parcelHelpers.export(exports, "getTypeScriptWorker", function() {
    return getTypeScriptWorker2;
});
parcelHelpers.export(exports, "setupJavaScript", function() {
    return setupJavaScript;
});
parcelHelpers.export(exports, "setupTypeScript", function() {
            ...
            value: function _getClient() {
                if (!this._client) {
                    ...
                    if (this._defaults.getEagerModelSync()) p = p.then(function(worker) {
                        var _this1 = _this;
                        if (_this._worker) return _this._worker.withSyncedResources(monaco_editor_core_exports.editor.getModels().filter(function(model) {
...
function getMode() {
    var resolve, reject;
    return require("2d5191f8beed6e4c");
}
...
var DiagnosticsAdapter = /*#__PURE__*/ function(Adapter1) {
    "use strict";
    _helpers.inherits(_class, Adapter1);
    ...
    function _class(_libFiles, _defaults, _selector, worker) {
        ...
        var onModelAdd = function(model) {
            ...
            var visibleSubscription = model.onDidChangeAttached(function() {
                ...
                if (onlyVisible) {
                    ...
                    else monaco_editor_core_exports.editor.setModelMarkers(model, _this._selector, []);
                }
            });
        ...
        var onModelRemoved = function(model) {
            monaco_editor_core_exports.editor.setModelMarkers(model, _this._selector, []);
        ...
        _this._disposables.push(monaco_editor_core_exports.editor.onDidCreateModel(function(model) {
            return onModelAdd(model);
        }));
        _this._disposables.push(monaco_editor_core_exports.editor.onWillDisposeModel(onModelRemoved));
        _this._disposables.push(monaco_editor_core_exports.editor.onDidChangeModelLanguage(function(event) {
        ...
        _this._disposables.push({
            dispose: function() {
                var _iteratorNormalCompletion = true, _didIteratorError = false, _iteratorError = undefined;
                try {
                    for(var _iterator = monaco_editor_core_exports.editor.getModels()[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true){
                    ...
                    return _regeneratorRuntimeDefault.default.wrap(function _callee$(_ctx) {
                        while(1)switch(_ctx.prev = _ctx.next){
                            ...
                            case 19:
                                ...
                                return _ctx.abrupt("return");
                            case 21:
                                monaco_editor_core_exports.editor.setModelMarkers(model, _this._selector, diagnostics.map(function(d) {
...
var SuggestAdapter = /*#__PURE__*/ function(Adapter2) {
    "use strict";
    _helpers.inherits(_class, Adapter2);
    var _super = _helpers.createSuper(_class);
    function _class() {
        _helpers.classCallCheck(this, _class);
                        ...
                        while(1)switch(_ctx.prev = _ctx.next){
                            ...
                            case 14:
                                suggestions = info.entries.map(function(entry) {
                                    ...
                                    var tags = [];
                                    if (((ref = entry.kindModifiers) === null || ref === void 0 ? void 0 : ref.indexOf("deprecated")) !== -1) tags.push(monaco_editor_core_exports.languages.CompletionItemTag.Deprecated);
                                    return {
                                        uri: resource,
                                        position: position,
                                        offset: offset,
...
function tagToString(tag) {
    ...
    if (tag.name === "param" && tag.text) {
        var _text = _helpers.toArray(tag.text), paramName = _text[0], rest = _text.slice(1);
...
var SignatureHelpAdapter = /*#__PURE__*/ function(Adapter3) {
    "use strict";
    _helpers.inherits(_class, Adapter3);
    var _super = _helpers.createSuper(_class);
    function _class() {
        _helpers.classCallCheck(this, _class);
        var _this;
...
var QuickInfoAdapter = /*#__PURE__*/ function(Adapter4) {
    "use strict";
    _helpers.inherits(_class, Adapter4);
    var _super = _helpers.createSuper(_class);
    function _class() {
        _helpers.classCallCheck(this, _class);
        return _super.apply(this, arguments);
...
var OccurrencesAdapter = /*#__PURE__*/ function(Adapter5) {
    "use strict";
    _helpers.inherits(_class, Adapter5);
    var _super = _helpers.createSuper(_class);
    function _class() {
        _helpers.classCallCheck(this, _class);
        return _super.apply(this, arguments);
...
var DefinitionAdapter = /*#__PURE__*/ function(Adapter6) {
    "use strict";
    _helpers.inherits(_class, Adapter6);
    var _super = _helpers.createSuper(_class);
...
var ReferenceAdapter = /*#__PURE__*/ function(Adapter7) {
    "use strict";
    _helpers.inherits(_class, Adapter7);
    var _super = _helpers.createSuper(_class);
    function _class(_libFiles, worker) {
        _helpers.classCallCheck(this, _class);
        var _this;
...
var OutlineAdapter = /*#__PURE__*/ function(Adapter8) {
    "use strict";
    _helpers.inherits(_class, Adapter8);
    var _super = _helpers.createSuper(_class);
    function _class() {
        _helpers.classCallCheck(this, _class);
        return _super.apply(this, arguments);
...
var FormatHelper = /*#__PURE__*/ function(Adapter9) {
    "use strict";
    _helpers.inherits(_class, Adapter9);
    var _super = _helpers.createSuper(_class);
    function _class() {
        _helpers.classCallCheck(this, _class);
        return _super.apply(this, arguments);
...
var FormatAdapter = /*#__PURE__*/ function(FormatHelper1) {
    "use strict";
    _helpers.inherits(_class, FormatHelper1);
    var _super = _helpers.createSuper(_class);
    function _class() {
        _helpers.classCallCheck(this, _class);
        return _super.apply(this, arguments);
...
var FormatOnTypeAdapter = /*#__PURE__*/ function(FormatHelper2) {
    "use strict";
    _helpers.inherits(_class, FormatHelper2);
    var _super = _helpers.createSuper(_class);
    function _class() {
        _helpers.classCallCheck(this, _class);
        return _super.apply(this, arguments);
...
var CodeActionAdaptor = /*#__PURE__*/ function(FormatHelper3) {
    "use strict";
    _helpers.inherits(_class, FormatHelper3);
    var _super = _helpers.createSuper(_class);
    function _class() {
        _helpers.classCallCheck(this, _class);
        return _super.apply(this, arguments);
...
var RenameAdapter = /*#__PURE__*/ function(Adapter10) {
    "use strict";
    _helpers.inherits(_class, Adapter10);
    var _super = _helpers.createSuper(_class);
    function _class(_libFiles, worker) {
        _helpers.classCallCheck(this, _class);
        var _this;
...
var InlayHintsAdapter = /*#__PURE__*/ function(Adapter11) {
    "use strict";
    _helpers.inherits(_class, Adapter11);
    var _super = _helpers.createSuper(_class);
    function _class() {
        _helpers.classCallCheck(this, _class);
        return _super.apply(this, arguments);
                        ...
                        while(1)switch(_ctx.prev = _ctx.next){
                            ...
                            case 11:
                                ...
                                return _ctx.abrupt("return", hints.map(function(hint) {
                                    return _helpers.objectSpread({}, hint, {
...
function setupMode(defaults, modeId) {
    ...
    var worker = function() {
        ...
        var _client;
        return (_client = client).getLanguageServiceWorker.apply(_client, _helpers.toConsumableArray(uris));
    };
...
},{"@swc/helpers":"erO4s","regenerator-runtime":"12Ae8","../../editor/editor.api.js":"8ZK4U","2d5191f8beed6e4c":"kKAbc","@parcel/transformer-js/src/esmodule-helpers.js":"5oERU"}],"kKAbc":[function(require,module,exports) {
module.exports = Promise.resolve(module.bundle.root("eMeK1"));

},{}]},[], null, "parcelRequire3aa6")

//# sourceMappingURL=tsMode.d6b990eb.js.map
